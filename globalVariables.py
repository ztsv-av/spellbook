...
SAVE_TRAIN_INFO_DIR = 'projects/testing_animals/training/info/'
SAVE_TRAIN_WEIGHTS_DIR = 'projects/testing_animals/training/weights/'
...
PERMUTATION_PROBABILITY_CLASSIFICATION = 1 / 5
