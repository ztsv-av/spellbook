from globalVariables import (
    BATCH_SIZES, NUM_EPOCHS, NUM_CLASSES, INPUT_SHAPE, FC_LAYERS, INITIAL_DROPOUT, DROPOUT_RATES, DROP_CONNECT_RATE,
    TRAIN_FILEPATHS, VAL_FILEPATHS, MAX_FILEPARTS_TRAIN, MAX_FILEPARTS_VAL, PERMUTATIONS_CLASSIFICATION, DO_PERMUTATIONS,
    OUTPUT_ACTIVATION, MODEL_POOLING, LEARNING_RATE, LR_DECAY_STEPS, LR_DECAY_RATE, SAVE_TRAIN_WEIGHTS_DIR, SAVE_TRAIN_INFO_DIR)
    ...
    for model_name, model_imagenet in MODELS_CLASSIFICATION.items():
        ...
        with strategy.scope():
            ...
            classification_model = buildClassificationImageNetModel(
                model_imagenet, INPUT_SHAPE, MODEL_POOLING, DROP_CONNECT_RATE, FC_LAYERS, INITIAL_DROPOUT, DROPOUT_RATES, NUM_CLASSES, OUTPUT_ACTIVATION, trainable=False)
